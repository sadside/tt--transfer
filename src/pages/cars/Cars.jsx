...
import { carsFilterData, carsTableBody, carsTableHeaders, carsTabs } from '../../db'
import './cars.scss'
...
const Cars = () => {
	...
	const currentCountry = carsTableBody.slice(firstCountryIndex, lastCountryIndex)
						...
						<AnimatePresence>
							{showSmartFilter && !showAddCar && !showEditCar && (
								<motion.divw
									...
									<SmartFilter filterData={carsFilterData} closeSmartFilter={closeSmartFilter} />
								</motion.divw>
							)}
						</AnimatePresence>
						<CarsTable
